...
function logCsv(file, msg)
 ...
 if file1 == nil then
  fileName = filePath.."/"..anlagen_id.."_DG_LOG_IM03_"..string.sub(now, 1, 10).."_2.csv"
  file = fileName
  file1 = io.open(file,"a")
  file1:write(anlagen_id..",SN:DG_LOG_IM03_,DG_LOG,0.0.0.0,2".."\n")
 ...
 if file2 == nil then
  fileNameZE = filePath.."/"..anlagen_id.."_ZE_LOG_IM03_"..string.sub(now, 1, 10).."_3.csv"
  file = fileNameZE
  file2 = io.open(file,"a")
  file2:write(anlagen_id..",SN:ZE_LOG_IM03_,ZE_LOG,0.0.0.0,3".."\n")
...
if not(settings.INVERTER[devS].dcCapacity and settings.INVERTER[devS].prRealRadSetpoint and settings.INVERTER[devS].prdcRealRadSetpoint and settings.INVERTER[devS].Module_inseries and settings.INVERTER[devS].Module_voc) then
 ...
 totalInvertersAcCapacity = settings.PLANT.totalInvertersAcCapacityS3 or 3
