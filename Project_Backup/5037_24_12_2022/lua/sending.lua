  ...
  for sendingRow in mydb:nrows("SELECT * from sending") do
    ...
    for lf in lfs.dir (sendingRow.path) do
      ...
      if string.sub(lf, -7) == ".unsent" then
        ...
        os.execute("/usr/sbin/curl -F file=@"..fN.." http://iplon-pvindia.com/vhosts/httpdocs/get_data_net.php".." -s --max-time 180")
		os.execute("/usr/sbin/curl -F file=@"..fN.." 192.168.50.38/vhosts/httpdocs/get_data.php".." -s --max-time 180")
